...
public class Graph {
    ...
    public static void main(String[] args) {
        ...
        MaxMin test = new MaxMin(graph0);       //build a new MaxMin project
        if((test.getMaxFlow()) < 0 || !test.getMinCut()){   //run maxFlow and minCut
            System.out.println("Error in MaxMin");      //catch errors
        }
    }
}